...
- **OpenAI GPT-5.3-Codex** 当程序员 — 写代码、执行命令
- **Gemini** 当审查员 — 检查代码质量
...
### 方式一：下载安装（推荐）
从 [Releases](../../releases) 下载适合你系统的安装包：

| 平台 | 文件 | 说明 |
|------|------|------|
| **Windows** | `omnicoder_*_x64-setup.exe` | 双击安装 |
| **macOS (ARM)** | `omnicoder_*_aarch64.dmg` | Apple Silicon (M1/M2/M3/M4) |
| **macOS (Intel)** | `omnicoder_*_x64.dmg` | Intel Mac |
| **Linux** | `omnicoder_*_amd64.AppImage` | 直接运行，无需安装 |
| **Linux (deb)** | `omnicoder_*_amd64.deb` | Debian/Ubuntu |

**无需安装 Node.js 或 Rust。** 下载 → 安装 → 配置 API Key → 开始使用！
